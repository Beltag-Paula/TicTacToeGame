...
public class MainMinMaxv2vers2 {
	...
	private static void gamePlay() {
		...
		//in every game the X has 5 positions and O has 4.
		//so in order to get out of the while condition after X has entered all the positions (0 to 4) the counter is incremented
		int counter = 0;

		
		while ( (gameOver == false) && (counter <= 4)) {
